...
def publishaPhoto(page_id,path_to_photo,page_access_token):
    photo_post = requests.post(f"https://graph.facebook.com/{page_id}/photos?url={path_to_photo}&access_token={page_access_token}")
    return photo_post

def schedulePhoto(page_id,path_to_photo,scheduled_time,page_access_token):
    photo_schedule = requests.post(f"https://graph.facebook.com/{page_id}/photos?published=false&url={path_to_photo}&scheduled_publish_time={scheduled_time}&access_token={page_access_token}")
